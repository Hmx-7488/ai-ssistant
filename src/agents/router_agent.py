...
class RouterAgent:
    ...
    KEYWORDS: Dict[str, Iterable[str]] = {
        ...
        "点餐咨询": ["想吃", "我要吃", "我要一份", "来一份", "点一份", "点餐", "辣吗", "忌口", "食材", "分量", "素食", "儿童餐", "营业", "地址", "wifi", "打包", "外卖", "会员", "优惠", "菜单", "所有菜", "全部菜", "能不能", "可以吗", "不要香菜", "有wifi", "停车", "发票", "生日", "有什么汤", "有什么饮品", "有什么甜品", "饮料", "喝的", "果汁", "茶水", "宝宝椅", "团购", "排队", "等位", "加饭", "续碗", "靠窗", "安静"],
