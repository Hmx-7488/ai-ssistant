...
class RouterAgent:
    ...
    KEYWORDS: Dict[str, Iterable[str]] = {
        ...
        "价格查询": ["多少钱", "价格", "几块", "几元", "贵吗", "收费", "费用", "人均", "消费", "报价"],
        "菜品推荐": ["推荐", "好吃", "特色", "招牌", "不知道吃什么", "来点", "必点", "预算", "个人", "人吃", "吃什么", "爸妈", "爸妈吃", "有什么", "过敏"],
        "点餐咨询": ["想吃", "我要吃", "点餐", "辣吗", "忌口", "食材", "分量", "素食", "儿童餐", "营业", "地址", "wifi", "打包", "外卖", "会员", "优惠", "菜单", "所有菜", "全部菜", "能不能", "可以吗", "不要香菜", "微辣", "中辣", "特辣", "有wifi", "停车", "发票", "包间", "生日", "儿童餐", "有什么汤", "有什么饮品", "有什么甜品", "红烧肉", "烤鱼", "牛肉", "鸡丁", "炒饭", "面条", "布丁", "西瓜汁", "酸梅汤", "蛋花汤", "时蔬"],
